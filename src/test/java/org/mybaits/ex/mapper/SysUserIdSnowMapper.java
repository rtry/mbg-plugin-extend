 ...
 * @version 0.0.3
 */
public interface SysUserIdSnowMapper extends     BaseMapper<SysUserIdSnow, Long, SysUserIdSnowExample>, InsertBatchMapper<SysUserIdSnow>, SelectOptionMapper<SysUserIdSnow, Long, SysUserIdSnowExample> {
}
