...
import org.mybaits.ex.base.AbstractExample;
 ...
 * @version 0.0.4
 */
public class SysUserIdAliasExample extends AbstractExample {

    public void or(SysUserIdAliasExample.Criteria criteria) {
        oredCriteria.add(criteria);
    }

    public SysUserIdAliasExample.Criteria or() {
        SysUserIdAliasExample.Criteria criteria = createCriteriaInternal();
        oredCriteria.add(criteria);
        return criteria;
    }

    public SysUserIdAliasExample.Criteria createCriteria() {
        SysUserIdAliasExample.Criteria criteria = createCriteriaInternal();
    ...
    protected SysUserIdAliasExample.Criteria createCriteriaInternal() {
        SysUserIdAliasExample.Criteria criteria = new SysUserIdAliasExample.Criteria();
        return criteria;
    }

    protected abstract static class AbstractGeneratedCriteria extends AbstractCriteria {
