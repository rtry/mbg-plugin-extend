...
import org.mybatis.generator.ex.mybatis_generator_maven_plugin.generator.mybatis3.xml.*;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        // =========================
        // 1. 批量插入(所有字段)
        AbstractXmlElementGenerator updateMapByExampleElementGenerator = new UpdateMapByExampleElementGenerator();
        initializeAndExecuteGenerator(updateMapByExampleElementGenerator, answer);
