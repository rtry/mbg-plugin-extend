...
public abstract class IntrospectedTable {
	 ...
	 *         non-BLOB fields). Note that the value
	 *         will be calculated regardless of whether the table has these
	 *         columns or not.
	 */
	 ...
	 *         will be calculated regardless of whether
	...
	public String getSelectAll() {
		return internalAttributes.get(InternalAttribute.ATTR_SELECT_ALL);
	}

	public void setSelectAll(String s) {
		internalAttributes.put(InternalAttribute.ATTR_SELECT_ALL, s);
	}
	 ...
	 * method will be called during validation
	 * of the configuration, so it should not rely on database introspection.
	 * This method simply tells the validator if
